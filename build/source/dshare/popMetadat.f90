...
subroutine popMetadat(err,message)
  ...
  deriv_meta(iLookDERIV%mLayerdTheta_dPsi)             = var_info('mLayerdTheta_dPsi'            , 'derivative in liquid water content w.r.t. matric potential'           , 'm-1'            , get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)

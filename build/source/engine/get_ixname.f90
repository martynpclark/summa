...
contains
 ...
 select case(trim(varName))
  ...
  case('fDerivMeth'      ); get_ixdecisions=iLookDECISIONS%fDerivMeth  ! (14) choice of method to calculate flux derivatives
  case('num_method'      ); get_ixdecisions=iLookDECISIONS%num_method  ! (15) choice of numerical method
  case('iterRefine'      ); get_ixdecisions=iLookDECISIONS%iterRefine  ! (16) choice of method to refine iteration increment
  case('fncScaling'      ); get_ixdecisions=iLookDECISIONS%fncScaling  ! (17) choice of function scaling method
  case('varScaling'      ); get_ixdecisions=iLookDECISIONS%varScaling  ! (18) choice of variable scaling method
  case('nrgFormul8'      ); get_ixdecisions=iLookDECISIONS%nrgFormul8  ! (19) choice of state variable for energy (enthalpy or temperature)
  case('LAI_method'      ); get_ixdecisions=iLookDECISIONS%LAI_method  ! (20) choice of method to determine LAI and SAI
  case('cIntercept'      ); get_ixdecisions=iLookDECISIONS%cIntercept  ! (21) choice of parameterization for canopy interception
  case('f_Richards'      ); get_ixdecisions=iLookDECISIONS%f_Richards  ! (22) form of Richards' equation
  case('groundwatr'      ); get_ixdecisions=iLookDECISIONS%groundwatr  ! (23) choice of groundwater parameterization
  case('hc_profile'      ); get_ixdecisions=iLookDECISIONS%hc_profile  ! (24) choice of hydraulic conductivity profile
  case('bcUpprTdyn'      ); get_ixdecisions=iLookDECISIONS%bcUpprTdyn  ! (25) type of upper boundary condition for thermodynamics
  case('bcLowrTdyn'      ); get_ixdecisions=iLookDECISIONS%bcLowrTdyn  ! (26) type of lower boundary condition for thermodynamics
  case('bcUpprSoiH'      ); get_ixdecisions=iLookDECISIONS%bcUpprSoiH  ! (27) type of upper boundary condition for soil hydrology
  case('bcLowrSoiH'      ); get_ixdecisions=iLookDECISIONS%bcLowrSoiH  ! (28) type of lower boundary condition for soil hydrology
  case('veg_traits'      ); get_ixdecisions=iLookDECISIONS%veg_traits  ! (29) choice of parameterization for vegetation roughness length and displacement height
  case('rootProfil'      ); get_ixdecisions=iLookDECISIONS%rootProfil  ! (30) choice of parameterization for the rooting profile
  case('canopyEmis'      ); get_ixdecisions=iLookDECISIONS%canopyEmis  ! (31) choice of parameterization for canopy emissivity
  case('snowIncept'      ); get_ixdecisions=iLookDECISIONS%snowIncept  ! (32) choice of parameterization for snow interception
  case('windPrfile'      ); get_ixdecisions=iLookDECISIONS%windPrfile  ! (33) choice of canopy wind profile
  case('astability'      ); get_ixdecisions=iLookDECISIONS%astability  ! (34) choice of stability function
  case('compaction'      ); get_ixdecisions=iLookDECISIONS%compaction  ! (35) choice of compaction routine
  case('snowLayers'      ); get_ixdecisions=iLookDECISIONS%snowLayers  ! (36) choice of method to combine and sub-divide snow layers
  case('thCondSnow'      ); get_ixdecisions=iLookDECISIONS%thCondSnow  ! (37) choice of thermal conductivity representation for snow
  case('thCondSoil'      ); get_ixdecisions=iLookDECISIONS%thCondSoil  ! (38) choice of thermal conductivity representation for soil
  case('canopySrad'      ); get_ixdecisions=iLookDECISIONS%canopySrad  ! (39) choice of method for canopy shortwave radiation
  case('alb_method'      ); get_ixdecisions=iLookDECISIONS%alb_method  ! (40) choice of albedo representation
  case('spatial_gw'      ); get_ixdecisions=iLookDECISIONS%spatial_gw  ! (41) choice of method for spatial representation of groundwater
  case('subRouting'      ); get_ixdecisions=iLookDECISIONS%subRouting  ! (42) choice of method for sub-grid routing

...
contains
 ...
 contains
  ...
  rAdd(ixSnowOnlyWat) = rAdd(ixSnowOnlyWat) ! done for clarity (state variable is volumetric water content, so melt-freeze is not included)
